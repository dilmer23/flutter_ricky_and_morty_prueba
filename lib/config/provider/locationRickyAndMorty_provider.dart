...
class LocationRickyAndMortyProviders extends ChangeNotifier{
  final LocationRickyAndMortyUseCase locationRickyAndMortyUseCase;
  LocationRickyAndMortyProviders({required this.locationRickyAndMortyUseCase});
}